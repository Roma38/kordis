...
function OneTimeTicketTableWithFilters() {
    ...
    return (
        <>
            ...
            {filters}
            <OneTimeTicketTable data={filteredData} lang={"cz"}/>
        </>
    );
}

function OneTimeTicketTable(params) {
    ...
    let rows = data.map((row) => {
        const rowClass = row.deleted ? "deleted" : null;
...
export default OneTimeTicketTableWithFilters;